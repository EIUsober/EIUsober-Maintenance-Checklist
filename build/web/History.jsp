                    ...
                    <c:forEach items="${listAll}" var="h">
                        <tbody>
                            <tr>
                                ...
                                <td><a href="ManageControl?mode=StaffViewCheckList&assetNo=${h.getAssetNo()}&id=${h.getId()}" ><i class="material-icons" data-toggle="tooltip" title="View">&#xf1c5;</i></a>
                                </td>
                            </tr>
                        </tbody>
                    </c:forEach>
                    ...
                    <c:forEach items="${listH}" var="h">
                        <tbody>
                            <tr>
                                ...
                                <td>${h.getDate()}</td>
                                <td>${h.getPerformedBy()}</td>
                                <td><a href="ManageControl?mode=StaffViewSchedule&assetNo=${h.getAssetNo()}&id=${h.getId()}" ><i class="material-icons" data-toggle="tooltip" title="View">&#xf1c5;</i></a>
                                </td>
                            </tr>
                        </tbody>
                    </c:forEach>
