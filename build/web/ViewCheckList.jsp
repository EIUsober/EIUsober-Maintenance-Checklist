        ...
        <div class="container">
            ...
            <c:if test="${sessionScope.account != null}">
                <c:if test="${account.getIsAdmin() == 1}">
                    <div style="margin-bottom: 20px"><a href="ManageControl?mode=view">< Back to Manage Page </a></div>
                </c:if>
                <c:if test="${account.getIsAdmin() == 0}">
                    <div style="margin-bottom: 20px"><a href="ManageControl?mode=viewByDepartment">< Back to Manage Page </a></div>
                </c:if>
            </c:if>
