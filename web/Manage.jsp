            ...
            <div class="table-responsive">
                <div class="table-wrapper">
                    <div class="table-title">
                        <div class="row">
                            ...
                            <div style="position: absolute; left: 35%">
                                <form action="ManageControl" method="get" style="display: flex">
                                    <!--end of col-->
                                    <input style="display: none" name="mode" type="text" value="search">
                                    <input style="width: 70%" name="text" class=" form-control-borderless" type="text" placeholder="Search by Name" value="${value}">                                    
                    ...
                    <div class="clearfix">
                        ...
                        <ul class="pagination">
                            <li class="page-item disabled"><a href="ManageControl?mode=view">Previous</a></li>
                                <c:forEach begin="1" end="${endPage}" var="i">
                                <li class="page-item active"><a href="ManageControl?mode=paging" class="page-link">${i}</a></li>
                                </c:forEach>
                            <li class="page-item"><a href="ManageControl?mode=paging" class="page-link">Next</a></li>
                        </ul>
                    </div>
                </div>
            </div>        
