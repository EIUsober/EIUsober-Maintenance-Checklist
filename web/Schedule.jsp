...
<html>
    ...
    <body>
        ...
        <div class="container">
            <c:if test="${!month.equals('2024-02')&&!month.equals('2024-03')}">
                <div>
            ...
            <c:if test="${month.equals('2024-02')}">
                ...
                <c:if test="${listHis.size() != 0}">
                    <div>
                        ...
                        <br>
                        <a style="color: red">Remaining: ${listSamp.size() - listD.size()} </a>
                    </div>
                    <div class="card-header my-3">Information</div>
                    <table class="table table-light">
                        <thead>
                        ...
                        <c:forEach items="${listHis}" var="h">
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown" style="display: flex; width: 170px">
                                            <input type="text" class="form-control" id="selectedItem" placeholder="${h.getAssigned()}" disabled="">
                                            <button class="btn btn-secondary dropdown-toggle" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                            </button>
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="MainControl?mode=updateScheduleExecute&staffID=I0001&id=${h.getId()}" onclick="updateSuccess()">I0001</a>
                                                <a class="dropdown-item" href="MainControl?mode=updateScheduleExecute&staffID=I0002&id=${h.getId()}" onclick="updateSuccess()">I0002</a>
                                                <a class="dropdown-item" href="MainControl?mode=updateScheduleExecute&staffID=I0003&id=${h.getId()}" onclick="updateSuccess()">I0003</a>                                            
                                                <!-- Add more options as needed -->
                                            </div>
                                        </div>
                                    </td>
                                    <td><a href="ManageControl?mode=StaffViewCheckList&assetNo=${h.getAssetNo()}" ><i class="material-icons" data-toggle="tooltip" title="View">&#xf1c5;</i></a>
                                    </td>
                                </tr>
                            </tbody>
                        </c:forEach>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="dropdown" style="display: flex; width: 170px">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                <a class="dropdown-item" href="MainControl?mode=updateSchedule3Execute&staffID=I0001&id=${h.getId()}" onclick="updateSuccess()">I0001</a>
                                                <a class="dropdown-item" href="MainControl?mode=updateSchedule3Execute&staffID=I0002&id=${h.getId()}" onclick="updateSuccess()">I0002</a>
                                                <a class="dropdown-item" href="MainControl?mode=updateSchedule3Execute&staffID=I0003&id=${h.getId()}" onclick="updateSuccess()">I0003</a>                                            
                                                <!-- Add more options as needed -->
                                            </div>
                                        </div>
                                    </td>
